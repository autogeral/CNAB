...
public class LineCnabHeaderArquivoExtratoTest {
    ...
    @Test
    public void LineCnabHeaderArquivoExtratoInterTest() throws ParseException {
        LineArchetype la = new LineCnab240v05HeaderArquivoExtrato();
        LineModel line = la.createModel();
        line.setRepresentation("07700000         205437537001290                    0000190000289984041 AUTO GERAL AUTOPECAS LTDA     BANCO INTER S.A.                        20502202515482600000310700000                                                                     ");

        //01
        //--3
        String codigoBanco = line.getFieldValue(LineCnab240v05HeaderArquivoExtrato.CODIGO_BANCO).toString();
        assertEquals("077", codigoBanco);
        //02
        //--4
        String lote = line.getFieldValue(LineCnab240v05HeaderArquivoExtrato.CODIGO_LOTE).toString();
        assertEquals("0000", lote);
        ...
        //--14
        String numeroInscricaoEmpresa = line.getFieldValueString(LineCnab240v05HeaderArquivoExtrato.NUMERO_INSCRICAO);
        assertEquals("05437537001290", numeroInscricaoEmpresa);
        //07
        //--15
        String brancos2 = line.getFieldValueString(LineCnab240v05HeaderArquivoExtrato.BRANCOS);
        //08
        ...
        //13
        //--5
        String numeroContaCorrente = line.getFieldValueString(LineCnab240v05HeaderArquivoExtrato.NUMERO_CONTA_COR).toString();
        assertEquals("28998404", numeroInscricaoEmpresa);
        //14
        //--1
        String brancos3 = line.getFieldValueString(LineCnab240v05HeaderArquivoExtrato.BRANCOS2);
        //15
