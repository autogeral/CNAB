 ...
 */
@Record
public class LineCnabRegistroSegmentoZPagamento extends LineModel{
    ...
    P/PAGAMENTOS ATRAVÉS DO CHEQUE, OP, DOC, TED E CRÉDITO EM CONTA CORRENTE
    ...
    */
    ...
    public String toString() {
        return "LineCnabRegistroSegmentoZPagamento{" + "codigoBanco=" + codigoBanco + ", codigoLote=" + codigoLote + ", tipoRegistro=" + tipoRegistro + ", numRegistro=" + numRegistro + ", codigoSegmento=" + codigoSegmento + ", autenticacaoEletronica=" + autenticacaoEletronica + ", seuNumero=" + seuNumero + ", brancos1=" + brancos1 + ", nossoNumero=" + nossoNumero + ", brancos2=" + brancos2 + '}';
    }
}
