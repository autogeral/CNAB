 ...
 *    11.08.2022
 */
public class LineCnabRegistroSegmentoZTributosPagamentoTest {
    @Test
    public void gerarSegmentoZTributosPagamento() throws ParseException { 
        LineCnabRegistroSegmentoZTributosPagamento record = new LineCnabRegistroSegmentoZTributosPagamento();
