 ...
 *   11.08.2022
 */
public class LineCnabRegistroSegmentoZTitulosPagamentoTest {
    @Test
    public void gerarSegmentoZTitulosPagamento() throws ParseException {
        LineCnabRegistroSegmentoZTitulosPagamento record = new LineCnabRegistroSegmentoZTitulosPagamento();
